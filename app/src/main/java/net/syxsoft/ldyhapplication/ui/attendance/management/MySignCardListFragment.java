 ...
 */
public class MySignCardListFragment extends BaseFragment {
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.action_settings:
                pushFragment(new MySignCardCalendarListFragment());
                break;
            case android.R.id.home:
                popFragment(new MySignCardCalendarListFragment());
                popFragment(new MyLeaveListFragment());
                break;
    ...
    public void onTabBtnClicked() {
        getHoldingActivity().pushFragment(new MyLeaveListFragment());
    }
}
